...
mods.extendedcrafting.TableCrafting.addShaped("bef7a0c4-f297-4eca-9605-be627388f66b", 0, <item:create:creative_motor>, [
	[<item:betteramethyst:amethyst_crystal_block>, <item:extendedcrafting:black_iron_block>, <item:steampowered:steel_large_cogwheel>, <item:extendedcrafting:black_iron_block>, <item:create:sequenced_gearshift>, <item:extendedcrafting:black_iron_block>, <item:steampowered:steel_large_cogwheel>, <item:extendedcrafting:black_iron_block>, <item:betteramethyst:amethyst_crystal_block>], 
	...
	[<item:steampowered:steel_large_cogwheel>, <item:create:electron_tube>, <item:extendedcrafting:singularity>.withTag({Id: "extendedcrafting:copper" as string}), <item:create:electron_tube>, <item:create:shaft>, <item:create:electron_tube>, <item:extendedcrafting:singularity>.withTag({Id: "extendedcrafting:copper" as string}), <item:create:electron_tube>, <item:steampowered:steel_large_cogwheel>], 
	[<item:extendedcrafting:black_iron_block>, <item:create:precision_mechanism>, <item:create:electron_tube>, <item:create:speedometer>, <item:steampowered:steel_steam_engine>, <item:create:speedometer>, <item:create:electron_tube>, <item:create:precision_mechanism>, <item:extendedcrafting:black_iron_block>], 
	[<item:create:sequenced_gearshift>, <item:create:shaft>, <item:create:shaft>, <item:steampowered:steel_steam_engine>, <item:paraglider:anti_vessel>, <item:steampowered:steel_steam_engine>, <item:create:shaft>, <item:create:shaft>, <item:create:sequenced_gearshift>], 
	[<item:extendedcrafting:black_iron_block>, <item:create:precision_mechanism>, <item:create:electron_tube>, <item:create:speedometer>, <item:steampowered:steel_steam_engine>, <item:create:speedometer>, <item:create:electron_tube>, <item:create:precision_mechanism>, <item:extendedcrafting:black_iron_block>], 
	[<item:steampowered:steel_large_cogwheel>, <item:create:electron_tube>, <item:extendedcrafting:singularity>.withTag({Id: "extendedcrafting:copper" as string}), <item:create:electron_tube>, <item:create:shaft>, <item:create:electron_tube>, <item:extendedcrafting:singularity>.withTag({Id: "extendedcrafting:copper" as string}), <item:create:electron_tube>, <item:steampowered:steel_large_cogwheel>], 
	[<item:extendedcrafting:black_iron_block>, <item:create:speedometer>, <item:create:electron_tube>, <item:create:precision_mechanism>, <item:create:shaft>, <item:create:precision_mechanism>, <item:create:electron_tube>, <item:create:speedometer>, <item:extendedcrafting:black_iron_block>], 
	[<item:betteramethyst:amethyst_crystal_block>, <item:extendedcrafting:black_iron_block>, <item:steampowered:steel_large_cogwheel>, <item:extendedcrafting:black_iron_block>, <item:create:sequenced_gearshift>, <item:extendedcrafting:black_iron_block>, <item:steampowered:steel_large_cogwheel>, <item:extendedcrafting:black_iron_block>, <item:betteramethyst:amethyst_crystal_block>]
